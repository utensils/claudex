...
Fetches a prebuilt, stripped, SHA256-verified binary into `~/.local/bin/claudex`. Override with `CLAUDEX_VERSION=v0.14.0` or `CLAUDEX_INSTALL_DIR=/usr/local/bin`. <!-- x-release-plz-version -->
...
```toml
[dependencies]
claudex = "0.14.0" # x-release-plz-version
```
