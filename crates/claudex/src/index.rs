...
pub const PRICING_REVISION: i64 = 5;
...
impl IndexStore {
    ...
    /// Sync any provider whose index is stale. Each provider has its own
    /// staleness window and data-root stamp, so they sync independently.
